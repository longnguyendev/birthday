...
for (let i = 1; i <= 12; i++) {
  ...
  item.setAttribute("src", `./public/images/img${i}.jpg`);
...
function mouse(e) {
  ...
  img1.style.top = `${10 + y * 0.012}%`;
  img1.style.left = `${-20 + x * 0.013}%`;
  img2.style.top = `${20 + y * 0.011}%`;
  img2.style.left = `${30 + x * 0.012}%`;
  img3.style.top = `${25 + y * 0.013}%`;
  img3.style.left = `${55 + x * 0.01}%`;
  img4.style.top = `${70 + y * 0.011}%`;
  img4.style.left = `${45 + x * 0.014}%`;
  img5.style.top = `${45 + y * 0.012}%`;
  img5.style.left = `${0 + x * 0.012}%`;
  img6.style.top = `${70 + y * 0.014}%`;
  img6.style.left = `${70 + x * 0.01}%`;
  img7.style.top = `${60 + y * 0.014}%`;
  img7.style.left = `${17 + x * 0.012}%`;
  img8.style.top = `${-20 + y * 0.013}%`;
  img8.style.left = `${40 + x * 0.012}%`;
  img9.style.top = `${-10 + y * 0.016}%`;
  img9.style.left = `${65 + x * 0.012}%`;
  img10.style.top = `${0 + y * 0.015}%`;
  img10.style.left = `${0 + x * 0.012}%`;
  img11.style.top = `${30 + y * 0.013}%`;
  img11.style.left = `${75 + x * 0.011}%`;
  img12.style.top = `${60 + y * 0.013}%`;
  img12.style.left = `${-20 + x * 0.011}%`;
